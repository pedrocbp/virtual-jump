...
func _draw() -> void:
	for x in range(20, 340, 18):
		draw_line(Vector2(x, 0), Vector2(mini(x + 9, 340), 0), Color(Design.GOLD, 0.36), 1.0, true)
	draw_circle(Vector2(12, 0), 3.0, Design.GOLD)
	draw_circle(Vector2(348, 0), 3.0, Design.GOLD)
